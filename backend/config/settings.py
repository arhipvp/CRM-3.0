...
GOOGLE_DRIVE_AUTH_MODE = config("GOOGLE_DRIVE_AUTH_MODE", default="auto")
...
TELEGRAM_INTERNAL_API_URL = config("TELEGRAM_INTERNAL_API_URL", default="")
TELEGRAM_INTERNAL_API_TOKEN = config("TELEGRAM_INTERNAL_API_TOKEN", default="")
TELEGRAM_INTERNAL_API_TIMEOUT_SECONDS = float(
    config("TELEGRAM_INTERNAL_API_TIMEOUT_SECONDS", default="15")
)
CRM_PUBLIC_URL = config("CRM_PUBLIC_URL", default="")
DEAL_PIN_LIMIT = int(config("DEAL_PIN_LIMIT", default="5"))
DEAL_TIME_TRACKING_ENABLED = _bool_env("DEAL_TIME_TRACKING_ENABLED", "true")
DEAL_TIME_TRACKING_TICK_SECONDS = max(
    5, int(config("DEAL_TIME_TRACKING_TICK_SECONDS", default="10"))
)
DEAL_TIME_TRACKING_CONFIRM_INTERVAL_SECONDS = max(
    DEAL_TIME_TRACKING_TICK_SECONDS,
    int(config("DEAL_TIME_TRACKING_CONFIRM_INTERVAL_SECONDS", default="600")),
)
