...
class PermissionsTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.executor_user = User.objects.create_user(username='executor', password='testpass123')
        ...
        self.executor_token = str(RefreshToken.for_user(self.executor_user).access_token)
