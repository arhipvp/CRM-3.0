...
1. Use `scripts/templates/business_data_template_new.xlsx` to mirror the expected sheets and columns for clients, deals, policies, payments, incomes, expenses, and tasks.
