from apps.codex_reader.models import CodexReadKey
from django.core.management.base import BaseCommand, CommandError


class Command(BaseCommand):
    help = "Issue, list, or revoke Codex read-only API keys."
