...
class Role(SoftDeleteModel):
    ...
    description = models.TextField(
        blank=True,
        help_text="Описание роли и её прав"
    )
...
class AuditLog(models.Model):
    ...
    object_id = models.CharField(
        max_length=255,
        help_text="ID изменяемого объекта"
    )
    object_name = models.CharField(
        max_length=255,
        blank=True,
        help_text="Название объекта для удобства"
    )
    ...
    description = models.TextField(
        blank=True,
        help_text="Подробное описание произошедшего изменения"
    )
    ...
    old_value = models.JSONField(
        null=True,
        blank=True,
        help_text="Старое значение (для update)"
    )
    new_value = models.JSONField(
        null=True,
        blank=True,
        help_text="Новое значение (для update)"
    )
