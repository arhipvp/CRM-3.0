...
class RoleResource(resources.ModelResource):
    class Meta:
        ...
        export_order = ('id', 'name', 'description', 'created_at', 'updated_at', 'deleted_at')
...
class PermissionResource(resources.ModelResource):
    class Meta:
        ...
        export_order = ('id', 'resource', 'action', 'created_at', 'updated_at', 'deleted_at')
...
class AuditLogResource(resources.ModelResource):
    class Meta:
        model = AuditLog
        fields = ('id', 'actor', 'object_type', 'object_id', 'object_name', 'action', 'description', 'created_at')
        export_order = ('id', 'actor', 'object_type', 'object_id', 'object_name', 'action', 'description', 'created_at')
...
class RoleAdmin(ImportExportModelAdmin):
    ...
    list_display = ['name', 'permissions_count', 'users_count', 'status_badge', 'created_at']
...
class PermissionAdmin(ImportExportModelAdmin):
    ...
    list_display = ['resource_display', 'action_display', 'roles_count', 'status_badge', 'created_at']
...
class AuditLogAdmin(admin.ModelAdmin):
    ...
    list_display = ['object_type_badge', 'object_name', 'action_badge', 'actor_display', 'created_at']
    list_filter = ('object_type', 'action', 'created_at', 'actor')
    search_fields = ('object_name', 'description', 'actor__username')
    readonly_fields = ('id', 'actor', 'object_type', 'object_id', 'object_name', 'action', 'description', 'old_value', 'new_value', 'created_at')
    ...
    fieldsets = (
        ...
        ('Действие', {
            'fields': ('action', 'actor', 'description')
        }),
        ('Изменения', {
...
class CustomUserAdmin(DjangoUserAdmin):
    list_display = ['username', 'email', 'roles_display', 'is_staff', 'is_active', 'last_login']
    ...
    def roles_display(self, obj):
        ...
        if roles:
            role_names = ', '.join([f'<span style="background-color: #667eea; color: white; padding: 2px 6px; border-radius: 3px; margin: 2px;">{role.role.name}</span>' for role in roles])
