...
class TaskResource(resources.ModelResource):
    class Meta:
        model = Task
        fields = ('id', 'title', 'description', 'deal', 'assignee', 'created_by', 'due_at', 'remind_at', 'status', 'priority', 'checklist', 'created_at', 'updated_at', 'deleted_at')
        export_order = ('id', 'title', 'description', 'deal', 'assignee', 'created_by', 'due_at', 'remind_at', 'status', 'priority', 'checklist', 'created_at', 'updated_at', 'deleted_at')
...
class TaskAdmin(ImportExportModelAdmin):
    ...
    list_display = ('title', 'deal', 'status_badge', 'priority_badge', 'assignee', 'due_at', 'created_at')
    search_fields = ('title', 'deal__title', 'assignee__username')
    list_filter = ('status', 'priority', 'due_at', 'created_at', 'deleted_at', 'assignee')
    ...
    fieldsets = (
        ('Основная информация', {
            'fields': ('id', 'title', 'deal', 'description')
        }),
        ('Статус и приоритет', {
