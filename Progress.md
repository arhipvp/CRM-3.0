...
## 4. Менеджер вложений
- Добавить `files` в модель `Deal`, реализовать загрузку/удаление файлов в API и фронте.
- Перенести UI из `frontend_example/components/ClientDetails.tsx:595-610` (input file, список, удаление, прогресс).
- Обработать состояния загрузки и ошибок, хранить временные ссылки.
