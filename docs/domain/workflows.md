...
5. Preview слияния по умолчанию предлагает самое длинное ФИО, оставляет телефон/email целевого клиента основными, а альтернативные контакты источников добавляет в итоговые заметки. Разные форматы одного телефона считаются одним номером.
