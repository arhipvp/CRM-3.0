          ...
          <div className="flex flex-wrap gap-2">
            {filterOptions.map((option) => (
              <button
                ...
                className={`rounded-full px-3 py-1 text-xs font-semibold transition ${notesFilter === option.value
                  ...
                  >
                    ...
                    <div className="text-xs text-slate-500 mt-2 flex items-center justify-between">
                      ...
                      {deal.nextContactDate && (
                        <span
                          className={`px-2 py-1 rounded text-xs font-medium ${isOverdue ? 'bg-red-100 text-red-700' : 'bg-blue-100 text-blue-700'
                            }`}
                        >
                ...
                <div className="flex flex-wrap gap-2 border-b border-slate-200 px-6 pt-5 pb-3">
                  {DEAL_TABS.map((tab) => (
                    <button
                      ...
                      className={`relative rounded-full px-4 py-2 text-sm transition ${activeTab === tab.id
