...
const createProps = (): AppRoutesProps => ({
  ...
  dealsActions: {
    ...
    onClientNormalizeName: noopAsync,
    selectedDealId: null,
    onSelectDeal: noop,
    ...
    onUpdateDealEvent: vi.fn(async () => ({
      id: 'event-1',
      deal: 'deal-1',
      eventType: 'manual' as const,
      eventTypeDisplay: 'Ручное событие',
      eventDate: '2027-06-17',
      title: 'Обновленная причина',
      description: '',
      sourceType: '',
      sourceId: '',
      metadata: {},
    ...
    onDeleteDealEvent: vi.fn(async () => undefined),
