...
const iconPaths: Record<AppIconName, ReactElement> = {
  ...
  ai: (
    <>
      <path d="M12 3a3 3 0 0 1 3 3v1.2a5 5 0 0 1 2.8 2.8H19a3 3 0 1 1 0 6h-1.2a5 5 0 0 1-2.8 2.8V20a3 3 0 1 1-6 0v-1.2A5 5 0 0 1 6.2 16H5a3 3 0 1 1 0-6h1.2A5 5 0 0 1 9 7.2V6a3 3 0 0 1 3-3Z" />
      <path d="M9.5 12h.01M14.5 12h.01M10 15.5c1.1.7 2.9.7 4 0" />
    </>
  ),
  plus: (
    <>
